...
public class PermissionTool: NSObject {
    // 录音权限
    static func audioAuthoried(_ hander: @escaping PermissionHanderClosure) {
    ...
    // 拍照权限
    static func takePhotoAuthoried(_ hander: @escaping PermissionHanderClosure) {
    ...
    // 相册权限
    static func libraryPhotoAuthoried(_ hander: @escaping PermissionBoolHanderClosure) {
    ...
    // 通知权限 请求
    func notifyRequest(_ hander: @escaping PermissionBoolHanderClosure) {
    ...
    // 通知权限 查看 (
    static func checkNotifyStatus(_ hander: @escaping (UNAuthorizationStatus) -> Void) {
